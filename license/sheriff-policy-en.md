...
## 3. Oversight Approval and Access to Non‑Public Content
...
## 4. Sheriff’s Orders
4.1. The Sheriff acts for the purpose of ensuring compliance with the [app store requirements](https://support.google.com/googleplay/android-developer/answer/9876937) governing user-generated content (including prohibitions on spam, illegal content, threats, incitement to hatred, etc.).
...
## 5. Procedure for Handling Complaints and Notifications
...
## 6. Confidentiality and Access to Data
